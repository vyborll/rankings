...
const links = [
  ...
  },
  {
    href: '/live',
    name: 'Live',
    icon: <StatusOnlineIcon className="h-4 w-4 mr-2" />,
    pathnames: ['/live'],
  },
];
...
const social = [
  {
    href: 'https://discord.gg/buFcc8x2tF',
    name: 'Discord',
    icon: (
      <svg
        className="h-5 w-5 fill-current text-dark-700 hover:text-white"
        role="img"
        viewBox="0 0 24 24"
  ...
  {
    href: 'https://twitter.com/nftrankingsnet',
    name: 'Twitter',
    icon: (
      <svg
        className="h-5 w-5 fill-current text-dark-700 hover:text-white"
                  ...
                  <Link href={link.href} key={i}>
                    <a
                      className={classNames(
                        pathname ===
                          link.pathnames.find(p => p.toLowerCase() === pathname.toLowerCase())
              ...
              <div className="hidden lg:flex flex-row space-x-6">
                ...
                {social.map((link, i) => (
                  <a
                    ...
                    target="_blank"
                    href={link.href}
                    className="flex flex-row items-center cursor-pointer text-dark-700 hover:text-white font-semibold"
                  >
                    {link.icon}
                  </a>
                ))}
