...
const Card: React.FC<Props> = ({ featured, collection }) => {
  return (
    <div
      className={`bg-dark-800 p-4 rounded relative overflow-hidden ${
        featured ? 'border border-green-950' : ''
      }`}
    >
      {featured && (
      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex flex-row items-center">
            <span className="flex flex-row items-center bg-dark-900 space-x-1 px-3 py-1 text-sm rounded-sm">
              <svg
